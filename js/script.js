    ...
    function importJSON() {
        ...
        function receivedText(e) {
            ...
            for (var can in newArr.canciones) {
                ...
                id.push(1000 + contar);
                var cancion= {
                    id:newArr.canciones[i].id,
                    nombre:(newArr.canciones[i].nombre),
                    artista:(newArr.canciones[i].artista),
                    tiempo: (newArr.canciones[i].duracion),
                    genero:(newArr.canciones[i].genero)
                };
                titulo.push(cancion.nombre);
                artista.push(cancion.artista);
                tiempo.push(cancion.tiempo);
                genero.push(cancion.genero);
                ...
                for(var idenarreglo in newArr.listacanciones[i].canciones)
                {
                    ...
                    for(var p = 0; p < canciones.length; p++)
                    {
                        ...
                        if(canciones[p].id === newArr.listacanciones[i].canciones[r])
                        {
                            ...
                            {
                                if(titulo[k]===canciones[p].nombre && artista[k]===canciones[p].artista)
                                {
                                    lista[contarList-1].push(id[k]);
                                }
                            }
                        }
                    }
